#include "nao_actions/actionExecutorPickupObject.h"
#include <pluginlib/class_list_macros.h>

PLUGINLIB_DECLARE_CLASS(nao_actions, action_executor_pickup_object,
        nao_actions::ActionExecutorPickupObject,
